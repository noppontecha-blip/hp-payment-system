...
// Same white/blue theme as bill-document.tsx / wht-certificate-document.tsx.
const BLUE = "#1d4ed8";
...
export function PaymentVoucherDocument({ data }: { data: ExpenseDocumentData }) {
  registerThaiFont();
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerRow}>
          <Text style={styles.title}>ใบสำคัญจ่าย</Text>
        ...
        <View style={styles.table}>
          ...
          {data.lines.map((line) => (
            <View style={styles.tr} key={line.seq}>
              ...
              <Text style={[styles.tdNum, { flex: 1 }]}>{formatNumber(line.vatAmount)}</Text>
              <Text style={[styles.tdNum, { flex: 1.1, borderRight: 0 }]}>
                {line.whtAmount > 0 ? formatNumber(line.whtAmount) : "-"}
              </Text>
            </View>
          ))}
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.signBox}>
            <Text style={styles.signLine}>ผู้ออกเอกสาร (ผู้ซื้อ)</Text>
          </View>
          <View style={styles.signBox}>
            <Text style={styles.signLine}>ผู้อนุมัติเอกสาร (ผู้ซื้อ)</Text>
            <Text>{data.company.authorized_signer_name || ""}</Text>
          </View>
          <View style={styles.signBox}>
            <Text style={styles.signLine}>ตราประทับ (ผู้ซื้อ)</Text>
          </View>
        </View>
      </Page>
    </Document>
