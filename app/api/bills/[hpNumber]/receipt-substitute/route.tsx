...
import { ReceiptSubstituteDocument } from "@/lib/pdf/receipt-substitute-document";
...
export async function GET(
  ...
  const buffer = await renderToBuffer(<ReceiptSubstituteDocument data={data} />);

  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      "Content-Type": "application/pdf",
      "Content-Disposition": `attachment; filename="receipt-substitute-${hpNumber}.pdf"`,
    },
  });
}
